      ...
      <AnimatePresence mode="wait">
        {open ? (
          <motion.div
            ...
            className="pointer-events-auto w-[min(92vw,22rem)] overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--bg-elevated)] shadow-[var(--shadow)]"
          >
            <div className="flex items-center justify-between gap-3 border-b border-[var(--border)] px-4 py-3">
              <div className="flex items-center gap-2.5">
                <HelperFace size="md" />
                <div>
                  <p className="font-display text-base font-medium italic leading-tight">
                    Order helper
                  </p>
                ...
                >
                  <div className="flex items-start gap-2 rounded-xl border border-[var(--border)] bg-[var(--accent-soft)] px-3 py-3">
                    ...
                    <p className="text-sm leading-relaxed">
                      Nice! Your details are filled into the contact form. Hit{" "}
                      <span className="font-semibold">Send Message</span> when
                      you&apos;re ready — no redirects.
                    </p>
                  </div>
                  <button
                    type="button"
